...
<form action="soli1.php">
<div class="row center-align">
    <button class="btn waves-effect waves-light" type="submit" name="registrarV">Solicitar um veículo<i class="material-icons right">add_box</i>
    </button>
</div>
</form>
...
<form action="s1.php">
<div class="row center-align">
    <button class="btn waves-effect waves-light" type="submit" name="soli">Consultar solicitação<i class="material-icons right">description</i>
    </button>
</div>
</form>
